...
import { markHydrated } from '@/i18n/hydration';
...
// Components render through react-native-web, so Platform.OS is 'web' and the i18n layer would
// hold back the device language waiting for a hydration that never happens here. No test renders
// into server markup, so every test starts hydrated.
markHydrated();
