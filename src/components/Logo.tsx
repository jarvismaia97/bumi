...
export function Logo({ size = 28 }: LogoProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 32 32">
      ...
      <Rect x={4} y={4} width={14} height={7} rx={3} fill="#f6ed94" />
      <Rect x={21} y={4} width={7} height={24} rx={3} fill="#9fcf9b" />
      <Rect x={4} y={14} width={14} height={14} rx={3} fill="#ffffff" fillOpacity={0.85} />
    </Svg>
  );
}
